    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                // OTLP/Core -- needed when either OTLPHTTP or OTLPGRPC traits are enabled.
                .target(name: "OTLPCore", condition: .when(traits: ["OTLPHTTP", "OTLPGRPC"])),
                .product(name: "SwiftProtobuf", package: "swift-protobuf", condition: .when(traits: ["OTLPHTTP", "OTLPGRPC"])),
                // OTLP/HTTP -- only when OTLPHTTP trait is enabled.
                ...
                // OTLP/GRPC -- only when OTLPGRPC trait is enabled.
